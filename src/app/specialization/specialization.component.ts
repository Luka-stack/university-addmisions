...
export class SpecializationComponent implements OnInit {
  ...
  otherSpecialization: Array<String>;
  ...
  constructor() {
    ...
    this.otherSpecialization = ["Przemysłowe systemy informatyczne", "Inżynieria Systemów Mikroinformatycznych"];
  }

  ngOnInit(): void {
  }

  getCorrectLink(fieldName: string) {
